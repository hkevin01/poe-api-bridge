...
def test_image_edit_openai_client():
    ...
    parser.add_argument("--prompt", default="Make the image more colorful and vibrant", help="Image edit prompt")
    parser.add_argument("--image", default="scripts/eaa3f4c4fa1a10fb233e0e9fac9ec25ce67d77e365093671892d181d519bbf49.jpeg", help="Path to image file")
    parser.add_argument("--model", default="StableDiffusionXL", help="Model to use for editing")
            ...
            if response.status_code == 200:
                ...
                if "data" in result and result["data"]:
                    for i, item in enumerate(result["data"]):
                        if "url" in item:
                            ...
                            print(f"Edited image {i+1} base64 length: {len(item['b64_json'])}")
                ...
                with open(image_path, 'rb') as image_file:
                    ...
                    if response_multi.status_code == 200:
                        ...
                        print(f"❌ Multiple image request failed with status code: {response_multi.status_code}")
                        print("Response:")
