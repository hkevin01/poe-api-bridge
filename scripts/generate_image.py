...
def main():
    ...
    parser.add_argument("--output", help="Save base64 image to file (only for b64_json format)")
    ...
    if args.format == "url":
        ...
        print(f"Base64 image generated (length: {len(response.data[0].b64_json)} characters)")
