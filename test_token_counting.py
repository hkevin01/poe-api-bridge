...
def test_count_tokens_simple():
    ...
    # Test longer text
    text = "This is a longer piece of text that should have more than just a few tokens."
...
def test_count_message_tokens_complex():
    ...
    messages = [
        ...
        fp.ProtocolMessage(role="bot", content="Sure! Here's an example of token counting...")
    ]
    ...
    completion_token_count = (
        count_tokens("Token counting is the process of...") +
