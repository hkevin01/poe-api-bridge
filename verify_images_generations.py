...
def main():
    ...
    response = client.images.generate(
        model=args.model, prompt=args.prompt, n=1, response_format="url"
    )
    ...
    response_multi = client.images.generate(
        model=args.model, prompt=args.prompt, n=3, response_format="url"
    )
    ...
    response_b64 = client.images.generate(
        model=args.model, prompt=args.prompt, n=1, response_format="b64_json"
    )
